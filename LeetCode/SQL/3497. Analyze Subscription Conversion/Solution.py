...
# https://leetcode.com/problems/analyze-subscription-conversion/description/?envType=problem-list-v2&envId=nc75h3ei
...
def analyze_subscription_conversion(user_activity: pd.DataFrame) -> pd.DataFrame:
    ...
    # Step 1: Get user_ids who had free_trial and paid
    ...
    # Step 2: Find users who had both
    converted_users = trial_users & paid_users

    # Step 3: Filter original dataframe
    df_filtered = user_activity[user_activity['user_id'].isin(converted_users)]

    # Step 4: Group and calculate average duration
    result = (
        df_filtered[df_filtered['activity_type'].isin(['free_trial', 'paid'])]
